...
| Profile-independent solution state | Domain and Chrome tests keep solution freshness unchanged across profile edits and active-profile switches, while option and version changes become stale. Saved profile snapshots remain immutable. |
